...
<div>
    ...
    <div class="ingredient-about">
        ...
        <iframe src="https://www.youtube.com/embed/${product[12].code}?vq=hd1080&loop=1&modestbranding=1&showinfo=0&rel=0&iv_load_policy=3&fs=0&controls=0&disablekb=1" width="700" height="400" frameborder="0"></iframe>
    </div>
</div>`;
